...
mod tests {
    ...
    fn check_type_attributes() {
        ...
        #[rustfmt::skip]
        assert_eq!(ConceptId::archetype().attributes(), vec![Owner::archetype(), Value::archetype()]);
    }
    ...
    fn check_attribute_constraints() {
        initialize_kb();
        assert_eq!(ConceptId::archetype().owner_archetype(), Tao::archetype());
        assert_eq!(ConceptId::archetype().value_archetype(), Tao::archetype());
    }
