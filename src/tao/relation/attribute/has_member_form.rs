...
impl From<HasMember> for Attribute {
    fn from(this: HasMember) -> Attribute {
...
mod tests {
    ...
    fn check_type_attributes() {
        initialize_kb();
        assert_eq!(HasMember::archetype().added_attributes(), vec![]);
        #[rustfmt::skip]
        assert_eq!(HasMember::archetype().attributes(), vec![Owner::archetype(), Value::archetype()]);
    }
    ...
    fn check_attribute_constraints() {
        initialize_kb();
        assert_eq!(HasMember::archetype().owner_archetype(), Tao::archetype());
        assert_eq!(HasMember::archetype().value_archetype(), Tao::archetype());
    }
