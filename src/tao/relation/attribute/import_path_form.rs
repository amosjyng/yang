...
mod tests {
    ...
    fn check_type_attributes() {
        ...
        #[rustfmt::skip]
        assert_eq!(ImportPath::archetype().attributes(), vec![Owner::archetype(), Value::archetype()]);
    }
    ...
    fn check_attribute_constraints() {
        initialize_kb();
        assert_eq!(ImportPath::archetype().owner_archetype(), Tao::archetype());
        assert_eq!(ImportPath::archetype().value_archetype(), Tao::archetype());
    }
