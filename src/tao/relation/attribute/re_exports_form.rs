...
mod tests {
    ...
    fn check_type_created() {
        ...
        assert_eq!(
            ReExports::archetype().internal_name(),
            Some(Rc::new(ReExports::TYPE_NAME.to_string()))
        );
    }
    ...
    fn check_type_attributes() {
        initialize_kb();
        #[rustfmt::skip]
        assert_eq!(ReExports::archetype().introduced_attribute_archetypes(), vec![]);
        #[rustfmt::skip]
        assert_eq!(ReExports::archetype().attribute_archetypes(), vec![Owner::archetype(), Value::archetype()]);
    }
    ...
    fn check_attribute_constraints() {
        initialize_kb();
        assert_eq!(
            ReExports::archetype().owner_archetype(),
            Tao::archetype().as_archetype()
        );
        assert_eq!(
            ReExports::archetype().value_archetype(),
            Tao::archetype().as_archetype()
        );
    }
