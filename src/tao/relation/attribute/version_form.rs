...
mod tests {
    ...
    fn check_type_created() {
        ...
        assert_eq!(
            ...
            Some(Rc::new(Version::TYPE_NAME.to_string()))
        );
    }
    ...
    fn check_type_attributes() {
        initialize_kb();
        #[rustfmt::skip]
        assert_eq!(Version::archetype().introduced_attribute_archetypes(), vec![]);
        #[rustfmt::skip]
        assert_eq!(Version::archetype().attribute_archetypes(), vec![Owner::archetype(), Value::archetype()]);
    }
