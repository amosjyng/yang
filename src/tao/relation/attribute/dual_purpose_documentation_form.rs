...
mod tests {
    ...
    fn check_type_attributes() {
        initialize_kb();
        #[rustfmt::skip]
        assert_eq!(DualPurposeDocumentation::archetype().introduced_attribute_archetypes(), vec![]);
        #[rustfmt::skip]
        assert_eq!(DualPurposeDocumentation::archetype().attribute_archetypes(), vec![Owner::archetype(), Value::archetype()]);
    }
