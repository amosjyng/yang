...
mod tests {
    ...
    fn check_type_created() {
        ...
        assert_eq!(
            UsesDataLogic::archetype().internal_name_str(),
            Some(Rc::from(UsesDataLogic::TYPE_NAME))
        );
    }
    ...
    fn check_type_attributes() {
        ...
        #[rustfmt::skip]
        assert_eq!(UsesDataLogic::archetype().attribute_archetypes(), vec![Owner::archetype()]);
    }
